...
import ru.otus.otuskotlin.yieldInsights.app.rabbit.controllers.IRabbitMqController
import ru.otus.otuskotlin.yieldInsights.app.rabbit.controllers.RabbitDirectControllerV1
import ru.otus.otuskotlin.yieldInsights.app.rabbit.controllers.RabbitDirectControllerV2
import java.util.concurrent.atomic.AtomicBoolean

// Класс запускает все контроллеры
@OptIn(ExperimentalCoroutinesApi::class)
class RabbitApp(
    appSettings: DepositAppSettings,
